...
class GO:
    ...
    def play(self, player1, player2, verbose=False):
        ...
        :param verbose: whether print input.txt hint and error information
        :return: piece type of winner of the game (0 if it's a tie).
        '''
        self.init_board(self.size)
        # Print input.txt hints and error message if there is a manual player
        ...
        while 1:
            ...
            if action != "PASS":
                # If invalid input.txt, continue the loop. Else it places a chess on the board.
